...
export const slots: SlotMeta[] = [
  {
    id: "quick",
    title: "Pro frog brain",
    description: "Runs the yes-side scouts and quick statements."
  },
  {
    id: "deep",
    title: "Con frog brain",
    description: "Builds the no-side claims and rebuttals."
  },
  {
    id: "judge",
    title: "Judge frog brain",
    description: "Weighs the case and writes the verdict."
  }
];
