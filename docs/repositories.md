...
| --- | --- |
| `polyvise/polyvise` | Core library |
| `polyvise/polyvise-ai` | `polyvise.ai` website |
| `polyvise/debatefrog` | `debatefrog.com` reference implementation |

Application repositories consume a released version of `@polyvise/debate-engine`. They do not import source files from sibling repositories.
