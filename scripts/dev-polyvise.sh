...
export POLYVISE_QUICK_MODEL="${POLYVISE_QUICK_MODEL:-openai/gpt-4o-mini}"
export POLYVISE_DEEP_MODEL="${POLYVISE_DEEP_MODEL:-openai/gpt-4o-mini}"
...
export POLYVISE_LLM_MAX_TOKENS="${POLYVISE_LLM_MAX_TOKENS:-1400}"

cd "$ROOT_DIR"
exec npm run dev:polyvise
